...
import com.nisal.mapper.ShiftReportMapper;
import com.nisal.model.*;
import com.nisal.payload.dto.ShiftReportDTO;
import com.nisal.repository.*;
import com.nisal.service.ShiftReportService;
    ...
    private List<Product> getTopSellingProducts(List<Order> orders) {
        ...
        for (Order order:orders){
            for (OrderItem item: order.getItems()){
                ...
                productSelesMap.put(product,
                        productSelesMap.getOrDefault(product, 0)+item.getQuantity());
            }
        }
